...
# build execution env.
docker build -t openssl-alpine -f ./setup-scripts/openssl/Dockerfile ./setup-scripts
docker build -t keytool-alpine -f ./setup-scripts/keytool/Dockerfile ./setup-scripts
